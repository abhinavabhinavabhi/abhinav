...
namespace login {
    ...
    public partial class imageDataSet : global::System.Data.DataSet {
        ...
        public partial class studentDataTable : global::System.Data.TypedTableBase<studentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public studentRow AddstudentRow(int Idno, string name, string section, string branch) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public studentRow FindByIdno(int Idno) {
        ...
        public partial class studentRow : global::System.Data.DataRow {
            ...
            public int Idno {
                get {
                    return ((int)(this[this.tablestudent.IdnoColumn]));
                }
                set {
...
namespace login.imageDataSetTableAdapters {
    ...
    public partial class studentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[student] WHERE (([Idno] = @Original_Idno) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_section = 1 AND [section] IS NULL) OR ([section] = @Original_section)) AND ((@IsNull_branch = 1 AND [branch] IS NULL) OR ([branch] = @Original_branch)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[student] ([Idno], [name], [section], [branch]) VALUES (@Idno, " +
                "@name, @section, @branch);\r\nSELECT Idno, name, section, branch FROM student WHER" +
                "E (Idno = @Idno)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[student] SET [Idno] = @Idno, [name] = @name, [section] = @section, [branch] = @branch WHERE (([Idno] = @Original_Idno) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_section = 1 AND [section] IS NULL) OR ([section] = @Original_section)) AND ((@IsNull_branch = 1 AND [branch] IS NULL) OR ([branch] = @Original_branch)));
SELECT Idno, name, section, branch FROM student WHERE (Idno = @Idno)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::login.Properties.Settings.Default.imageConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Idno, name, section, branch FROM dbo.student";
        ...
        public virtual int Fill(imageDataSet.studentDataTable dataTable) {
        ...
        public virtual imageDataSet.studentDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            imageDataSet.studentDataTable dataTable = new imageDataSet.studentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(imageDataSet.studentDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Idno, string Original_name, string Original_section, string Original_branch) {
        ...
        public virtual int Insert(int Idno, string name, string section, string branch) {
        ...
        public virtual int Update(int Idno, string name, string section, string branch, int Original_Idno, string Original_name, string Original_section, string Original_branch) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string section, string branch, int Original_Idno, string Original_name, string Original_section, string Original_branch) {
            return this.Update(Original_Idno, name, section, branch, Original_Idno, Original_name, Original_section, Original_branch);
        }
    }
